 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				'quiz_answer_summaries' => array(
					...
					'passing_status' => array('type' => 'integer', 'null' => false, 'default' => '0', 'comment' => '0:合格判定なし 1:合格 2:不合格'),
					...
					'within_time_status' => array('type' => 'integer', 'null' => false, 'default' => '0', 'comment' => '0:時間判定なし 1:時間内 2:時間オーバー'),
				...
				'quiz_answers' => array(
					...
					'correct_status' => array('type' => 'integer', 'null' => false, 'default' => 0, 'comment' => '0:未採点 1:正解 2:不正解'),
				...
				'quiz_frame_display_quizzes' => array(
					'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		...
		'down' => array(
			'drop_table' => array(
				'quiz_answer_summaries', 'quiz_answers', 'quiz_blocks_settings', 'quiz_choices', 'quiz_correct', 'quiz_frame_display_quizzes', 'quiz_frame_settings', 'quiz_pages', 'quiz_questions', 'quizzes'
			),
		),
	);

<?php
/**
 * QuizBlocksController::index()のテスト
 *
 ...
 */
class QuizBlocksControllerIndexTest extends BlocksControllerTest {
 ...
 * @var string
 */
	protected $_editController = 'quiz_blocks';
 ...
 * index()のテスト
 *
 * 小テストは追加、編集用のコントローラを独自に持っているためここにオーバーライド
 * @return void
 */
	public function testIndex() {
		...
		$blockId = '2';
		$editLink = $url;
		$editLink['controller'] = 'quiz_edit';
		$editLink['action'] = 'edit_question';
		$editLink['block_id'] = $blockId;
		$editLink['key'] = '4f5afb0a25dabf24ce9697ea5b07abcc';
 ...
 * index()のブロックなしテスト
 *
 * 小テストはブロック一覧ではなく、コンテンツ一覧を出しているため独自実装が必要となる
 * @return void
 */

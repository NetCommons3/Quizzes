<?php
/**
 * QuizzesOwnAnswerQuizComponent::checkOwnAnsweredKeys()のテスト
 *
 ...
 */
class QuizzesOwnAnswerQuizComponentCheckOwnAnsweredKeysTest extends NetCommonsControllerTestCase {
...
/**
 * checkOwnAnsweredKeys()のテスト
 *
 * @return void
 */
	public function testCheckOwnAnsweredKeys() {
		//テストコントローラ生成

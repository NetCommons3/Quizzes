<?php
/**
 * QuizzesAnswerStartComponent::saveStartQuizOfThisUser()のテスト
 *
 ...
 */
class QuizzesAnswerStartComponentSaveStartQuizOfThisUserTest extends NetCommonsControllerTestCase {
...
/**
 * saveStartQuizOfThisUser()のテスト
 *
 * @return void
 */
	public function testSaveStartQuizOfThisUser() {
		//テストコントローラ生成
		...
		//テスト実行
		$this->controller->QuizzesAnswerStart->saveStartQuizOfThisUser('quiz_1');

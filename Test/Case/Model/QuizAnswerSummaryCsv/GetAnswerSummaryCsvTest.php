 ...
 */
	public function dataProviderGet() {
		$expect = array(
			...
			array(
				'Guest', '2016-06-10 06:35:02', '10', '1', '0', '40', '', __d('quizzes', 'Ungraded'),
			),	// data1
			array(
				'Guest', '2016-06-10 06:36:46', '77', '1', '8', '59', '正解で部分点でお願いします', 8,
			),	// data2
			array(
				'Guest', '2016-06-10 06:37:26', '24', '1', '10', '64', '正解で満点でお願いします', 10,
			),	// data3
			array(
				'Guest', '2016-06-10 06:38:17', '30', '1', '2', '45', '間違い部分点でお願いします', 2,
			),	// data4
			array(
				'Guest', '2016-06-10 06:39:14', '35', '1', '0', '40', '間違いで０点でお願いします', 0,
			),	// data5
			array(
		...
		$expect3 = array(
			...
			array(
				'Guest', '2016-06-10 06:20:53', '14', '1', '10', '50.0', '新規選択肢1', 10,
			),	// data2
		);
		return array(
			array('51', $expect),

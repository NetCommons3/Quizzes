<?php
/**
 * QuizQuestionValidateBehavior::validates()テスト用Fixture
 *
 ...
 *
 * @author AllCreator <info@allcreator.net>
 * @package NetCommons\Quizzes\Test\Fixture
 */
class TestQuizQuestionValidateBehaviorValidatesModelFixture extends CakeTestFixture {
 ...
 */
	public $records = array(
		array(
			...
			'created_user' => '1',
			'created' => '2016-06-09 10:22:18',
			'modified_user' => '1',
			'modified' => '2016-06-09 10:22:18'
		),
		array(
			'id' => '2',
			'language_id' => '2',

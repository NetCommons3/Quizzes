<?php
/**
 * quizzes status label for angular template
 *
...
<span ng-switch="<?php echo $status ?>">
	...
	<span ng-switch-default>
		<span ng-switch="<?php echo $periodRangeStat; ?>">
			<span ng-switch-when="<?php echo QuizzesComponent::QUIZ_PERIOD_STAT_BEFORE ?>" class="label label-default"><?php echo __d('quizzes', 'Before public'); ?></span>
			<span ng-switch-when="<?php echo QuizzesComponent::QUIZ_PERIOD_STAT_END ?>" class="label label-default"><?php echo __d('quizzes', 'End'); ?></span>
	</span>
</span>
